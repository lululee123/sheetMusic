import { useState, useEffect, useMemo, lazy, useRef, FC, ReactElement, ComponentType } from 'react';
...
const useRouter = (routes: CustomRoute, history: History, store: Store) => {
	...
	async function asyncLocationChange() {
		setComponent({ ...Component, loading: true });
